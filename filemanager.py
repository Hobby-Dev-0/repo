...
async def _(event):
    ...
    OUTPUT = f"**Files in [userbot](t.me/W2H_Userbot) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
  'ls_local', None, 'Gives the list of downloaded medias in your userbot server.'
).add_command(
  'ls_root', None, 'Gives the list of all files in root directory of userbot repo.'
).add_command(
  'ls_saved', None, 'Gives the list of all files in Saved directory of your userbot server'
).add_command(
